...
const AddHostel = () => {
  ...
  const addFacility = (facility) => {
    if (facility && !currentRoom.facilities.includes(facility)) {
      setCurrentRoom({
        ...currentRoom,
        facilities: [...currentRoom.facilities, facility],
      });
    }
  };
  ...
  const isRoomValid = () => {
    return (
      ...
      currentRoom.totalCapacity &&
      currentRoom.totalCapacity > 0
    );
  };
  ...
  return (
    <div className="min-h-screen hostel-editor-page hostel-editor-page--add bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">
          List Your Hostel
        </h1>
        <p className="text-gray-600 mb-8">
          Follow the steps below to create your hostel listing
        </p>
        ...
        <div className="mb-8 flex items-center justify-center space-x-4">
          ...
          >
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${step >= 1 ? "bg-blue-600 text-white" : "bg-gray-300"}`}
            >
              1
            </div>
          ...
          >
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${step >= 2 ? "bg-blue-600 text-white" : "bg-gray-300"}`}
            >
              2
            </div>
            <span className="ml-2 font-medium hidden sm:inline">
          ...
          {step === 1 && (
            <div className="bg-white p-8 rounded-lg shadow-sm space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-3">
                  📸 Upload multiple photos of your hostel (common areas,
                  facilities, etc.)
                </p>
                <input
                  type="file"
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-3">
                  🌐 Paste a link to your 360° virtual tour (e.g., Matterport,
                  Google Street View)
                </p>
                <input
                  type="url"
            ...
            <div className="space-y-6">
              <div className="bg-white p-8 rounded-lg shadow-sm">
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-600">
                    Add different room categories available in your hostel
                  </p>
                </div>
                ...
                <div className="border-2 border-dashed border-blue-300 rounded-lg p-6 bg-blue-50">
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-gray-500 mb-2">
                      Enter the total number of students that can be
                      accommodated in this room type.
                    </p>
                    <input
                      type="number"
                      min="1"
                      ...
                      onChange={async (e) => {
                        ...
                        if (files.length > 0) {
                          ...
                          setCurrentRoom({
                            ...currentRoom,
                            roomImages: [
                              ...currentRoom.roomImages,
                              ...newImages,
                            ],
                            roomImagesFiles: [
                              ...(currentRoom.roomImagesFiles || []),
                              ...newImageFiles,
                            ],
                          });
                        }
                          ...
                          >
                            ...
                            <button
                              ...
                              onClick={() =>
                                setCurrentRoom({
                                  ...currentRoom,
                                  roomImages: currentRoom.roomImages.filter(
                                    (_, i) => i !== idx,
                                  ),
                                  roomImagesFiles: (
                                    currentRoom.roomImagesFiles || []
                  ...
                  <div className="mb-4">
                    <label className="block text-sm font-medium text-gray-700 mb-3">
                      Room Facilities (Tap to select)
                    </label>

                    {Object.entries(commonFacilities).map(
                      ([category, items]) => (
                ...
                {roomTypes.length > 0 && (
                  <div className="mt-6">
                    <h3 className="font-semibold text-lg mb-3">
                      Added Room Types ({roomTypes.length})
                    </h3>
                          ...
                          <div className="flex items-center justify-between p-4 bg-gray-50">
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">
                                  GH₵{room.price} / semester
                                </p>
                                <p className="text-xs text-gray-500">
                                  {room.facilities.length} facilities •
                                  Capacity: {room.totalCapacity} students
                                </p>
                              </div>
                            </div>
