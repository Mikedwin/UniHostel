...
const AnalyticsDashboard = ({ token }) => {
  ...
  const handleExport = async (format) => {
    try {
      ...
      alert(
        `Export logged successfully. ${format.toUpperCase()} export would be generated here.`,
      );
    } catch (err) {
      alert("Export failed");
    }
    ...
    return [
      ...
      },
      {
        ...
        value:
          ...
          overview.approvedApps -
          overview.rejectedApps,
      },
    ];
  };
  ...
  return (
    <div className="operations-surface admin-analytics space-y-6">
      {/* Date Range Filters */}
      <div className="rounded-2xl border border-slate-200 bg-slate-50/50 p-4">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="ml-auto flex gap-2">
            <FilterButton variant="danger" onClick={() => handleExport("pdf")}>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                {overview?.totalStudents} students, {overview?.totalManagers}{" "}
                managers
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-green-600">
                {overview?.approvalRate}% approved
              </p>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                {overview?.approvedApps} approved
              </p>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                of {overview?.totalHostels} total
              </p>
            </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h3 className="text-lg font-bold mb-4">
          Peak Seasons (Monthly Applications)
        </h3>
        <ResponsiveContainer width="100%" height={250}>
          <BarChart
