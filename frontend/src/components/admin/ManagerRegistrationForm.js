...
const ManagerRegistrationForm = ({ token, onSuccess }) => {
  ...
  return (
    <div className="operations-surface operations-registration max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-blue-100 text-sm">
              Create a new hostel manager account
            </p>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="border-t pt-4">
            ...
            <div className="mb-4">
              ...
              <select
                ...
                className="w-full border border-gray-300 rounded-md p-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
                <option value="What is your email address?">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>
                • The manager account will be created with full access
                immediately
              </li>
              <li>
                • Manager can log in using the email and password provided
              </li>
              <li>
                • Make sure to securely share the credentials with the manager
              </li>
          ...
          <div className="flex gap-3 pt-4">
            ...
            >
              {loading ? (
                <>
                  <div className="unihostel-button-loader"></div>
                  Creating...
                </>
              ) : (
                <>
